...
docker_build(
    ...
    context = "./",
    only = ["./sdk", "./solana", "./cli/package.json", "./sui/ts/package.json", "./xrpl/ts/package.json", "./evm/ts/package.json", "./package.json", "./bun.lock", "./bunfig.toml", "./tsconfig.json", "./tsconfig.cjs.json", "./tsconfig.esm.json"],
...
docker_build(
    ref = "ntt-ci",
    context = "./",
    only=["./sdk", "./cli/package.json", "./sui/ts/package.json", "./xrpl/ts/package.json", "./package.json", "./bun.lock", "./bunfig.toml", "jest.config.ts", "tsconfig.json", "tsconfig.esm.json", "tsconfig.cjs.json", "tsconfig.test.json"],
