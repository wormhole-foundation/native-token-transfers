...
use native_token_transfers::transceivers::wormhole::SetTransceiverPeerArgs;
...
pub fn set_transceiver_peer(
    ...
    let data = native_token_transfers::instruction::SetWormholePeer { args };

    let accounts = native_token_transfers::accounts::SetTransceiverPeer {
        config: ntt.config(),
