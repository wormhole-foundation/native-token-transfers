...
use native_token_transfers::instructions::InitializeArgs;
...
pub fn initialize_with_token_program_id(
    ...
    let data = native_token_transfers::instruction::Initialize { args };

    let bpf_loader_upgradeable_program = BpfLoaderUpgradeable::id();
    let accounts = native_token_transfers::accounts::Initialize {
