...
export interface WormholeTransceiverInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "additionalBlocks",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "customConsistencyLevel",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "customConsistencyLevelAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface WormholeTransceiver extends BaseContract {
  ...
  additionalBlocks: TypedContractMethod<[], [bigint], "view">;

  consistencyLevel: TypedContractMethod<[], [bigint], "view">;

  customConsistencyLevel: TypedContractMethod<[], [bigint], "view">;

  customConsistencyLevelAddress: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "additionalBlocks"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "consistencyLevel"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "customConsistencyLevel"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "customConsistencyLevelAddress"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
